...
1. **Download or clone this repository**
   ```bash
   git clone https://github.com/nickyc1/ThreadCopy-Browser-Ext.git
   ```
...
**Questions or issues?** [Open a GitHub issue](https://github.com/nickyc1/ThreadCopy-Browser-Ext/issues) and I'll help you out!
